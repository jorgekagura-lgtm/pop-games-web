...
try {
    ...
    echo "<h1 style='color:green; font-family:sans-serif;'>¡ÉXITO TOTAL! Las tablas usando la ruta externa están listas.</h1>";

} catch (PDOException $e) {
    echo "<h1 style='color:red; font-family:sans-serif;'>Fallo en la base de datos externa:</h1> " . $e->getMessage();
}
?>
