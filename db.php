<?php
// Conexión a la nueva base de datos de Render MySQL
$host = 'mysql-7fbb'; 
$db   = 'popgames_db';
$user = 'jorge';
...
try {
    ...
    // Tu estructura completa y datos en formato SQL
    $sql = "
    ...
    INSERT IGNORE INTO `juegos` (`id`, `nombre`, `genero`, `descripcion`, `imagen`, `galeria`) VALUES
    ...
    (8, 'Dragon Age: Inquisition', 'RPG', 'Lideras la Inquisición para salvar al mundo de una catástrofe mágica...', 'imagenes/dragonage.webp', '[\"imagenes/dragonage.webp\",\"imagenes/dragonage2.webp\",\"imagenes/dragonage3.webp\",\"imagenes/dragonage4.webp\"]'),
    ...
    (11, 'Roblox', 'Sandbox', 'Plataforma donde millones de usuarios crean sus propios juegos...', 'imagenes/roblox.webp', '[\"imagenes/roblox.webp\",\"imagenes/roblox2.webp\",\"imagenes/roblox3.webp\",\"imagenes/roblox4.webp\"]'),
    ...
    INSERT IGNORE INTO `usuarios` (`id`, `username`, `password`, `nombre_completo`, `apellido_completo`, `correo`, `codigo_verificacion`, `verificado`) VALUES
    ...
    INSERT IGNORE INTO `reviews` (`id`, `id_juego`, `usuario`, `texto`, `calificacion`, `fecha`) VALUES
    (1, 1, 'jorge', 'Esta guapo este juego', 10, '2026-05-13 21:37:18'),
    (2, 1, 'samuel', 'Estoy de acuerdo contigo jorge', 10, '2026-05-13 21:38:40');
    ";

    $pdo->exec($sql);
    echo "<h1 style='color:green;'>¡Éxito rotundo! Las tablas y datos de Pop Games se han importado correctamente en Render.</h1>";
    echo "<p>Ya puedes borrar este archivo importar.php de tu GitHub por seguridad.</p>";

} catch (PDOException $e) {
    die("<h1 style='color:red;'>Error al importar:</h1> " . $e->getMessage());
}
?>
